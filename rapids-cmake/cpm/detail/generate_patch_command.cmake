...
function(rapids_cpm_generate_patch_command package_name version patch_command build_patch_only)
  ...
  elseif(NOT override_has_git AND NOT override_has_url)
    string(JSON _v ERROR_VARIABLE no_git_url_default GET "${full_default_json}" git_url)
    string(JSON _v ERROR_VARIABLE no_url_default GET "${full_default_json}" url)
    if(no_git_url_default AND NOT no_url_default)
      set(use_git_patch FALSE)
    endif()
  endif()
